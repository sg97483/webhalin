...
while True:
    ...
    #test
    if is_no_db_test:
        tempTarget1 = ['0', '19488', '25라9734', '평일1일권', '2021-11-05 08:00:00', '202111250800']
        tempTarget2 = ['0', '19488', '360도3068', '평일1일권', '2021-11-05 08:00:00', '202111250800']
        tempTarget3 = ['0', '19488', '25무0272', '평일1일권', '2021-10-29 08:00:00', '202110290800']
        tempTarget4 = ['0', '19488', '53루2025', '평일1일권', '2021-10-29 08:00:00', '202110290800']
        tempTarget5 = ['0', '19492', '256소1544', '평일1일권', '2021-11-05 08:00:00', '202111250800']
        tempTarget6 = ['0', '19493', '23누0240', '평일1일권', '2021-11-05 08:00:00', '202111250800']
        tempTarget7 = ['0', '19488', '11도5309', '평일1일권', '2021-10-29 08:00:00', '202110290800']
        tempTarget8 = ['0', '19489', '35버0715', '평일1일권', '2021-10-29 08:00:00', '202110290800']
