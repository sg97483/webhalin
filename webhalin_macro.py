...
while True:
    ...
    #test
    if is_no_db_test:
        tempTarget1 = ['0', '19445', '135마7410 ', '평일1일권', '2021-11-18 08:00:00', '202111180800']
        tempTarget2 = ['0', '19070', '111테1111 ', '심야권', '2021-11-05 08:00:00', '202111250800']
        tempTarget3 = ['0', '19070', '135마7410 ', '평일 10시간권', '2021-10-29 08:00:00', '202110290800']
        # tempTarget4 = ['0', '19400', '41저6961', '평일1일권', '2021-10-29 08:00:00', '202110290800']
        # tempTarget5 = ['0', '19400', '277부9906', '평일1일권', '2021-11-05 08:00:00', '202111250800']
        # tempTarget6 = ['0', '19400', '175소6783', '평일1일권', '2021-11-05 08:00:00', '202111250800']
        # tempTarget7 = ['0', '19400', '135주3504', '평일1일권', '2021-10-29 08:00:00', '202110290800']
        # tempTarget8 = ['0', '19400', '25무0272', '평일1일권', '2021-10-29 08:00:00', '202110290800']
        # tempTarget9 = ['0', '19400', '42주0198', '평일1일권', '2021-11-05 08:00:00', '202111250800']
        # tempTarget10 = ['0', '19400', '277부9906', '평일1일권', '2021-10-29 08:00:00', '202110290800']
        # tempTarget11 = ['0', '19400', '175소6783', '평일1일권', '2021-10-29 08:00:00', '202110290800']
