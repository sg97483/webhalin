...
while True:
    ...
    #test
    if is_no_db_test:
        tempTarget1 = ['0', '19400', '59어4975 ', '평일1일권', '2021-11-29 08:00:00', '202111290800']
        # tempTarget2 = ['0', '19400', '325어5511 ', '평일1일권', '2021-11-29 08:00:00', '202111290800']
        # tempTarget3 = ['0', '19400', '14루9405 ', '평일1일권', '2021-11-29 08:00:00', '202111290800']
        # tempTarget4 = ['0', '19400', '34수4746', '평일1일권', '2021-11-29 08:00:00', '202111290800']
        # tempTarget5 = ['0', '19400', '35버0715', '평일1일권', '2021-11-29 08:00:00', '202111290800']
        # tempTarget6 = ['0', '19400', '29더1483', '평일1일권', '2021-11-29 08:00:00', '202111290800']
        # tempTarget7 = ['0', '19400', '277부9906', '평일1일권', '2021-11-29 08:00:00', '202111290800']
        # tempTarget8 = ['0', '19400', '175소6783', '평일1일권', '2021-11-29 08:00:00', '202111290800']
        # tempTarget9 = ['0', '19400', '41저6961', '평일1일권', '2021-11-29 08:00:00', '202111290800']
        # tempTarget10 = ['0', '19400', '308저3578', '평일1일권', '2021-11-29 08:00:00', '202111290800']
        # tempTarget11 = ['0', '19400', '126주 6851', '평일1일권', '2021-11-29 08:00:00', '202111290800']
        # tempTarget12 = ['0', '19400', '21도9311', '평일1일권', '2021-11-29 08:00:00', '202111290800']
        # tempTarget13 = ['0', '19400', '03누8472', '평일1일권', '2021-11-29 08:00:00', '202111290800']
        ...
        try:
            ...
            # web_har_in(tempTarget5)
            # web_har_in(tempTarget6)
            # web_har_in(tempTarget7)
            # web_har_in(tempTarget8)
            # web_har_in(tempTarget9)
            # web_har_in(tempTarget10)
            # web_har_in(tempTarget11)
            # web_har_in(tempTarget12)
            # web_har_in(tempTarget13)
            break
